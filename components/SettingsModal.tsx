...
const MODEL_OPTIONS = {
  ...
  anthropic: [
    { value: 'anthropic/claude-haiku-4-5', label: 'Claude Haiku 4.5 (Schnell)' },
    { value: 'anthropic/claude-sonnet-4-6', label: 'Claude Sonnet 4.6 (Ausgewogen)' },
    { value: 'anthropic/claude-opus-4-7', label: 'Claude Opus 4.7 (Leistungsstark)' },
  ],
  openai: [
